const CACHE_NAME = 'humanevo-premium-studio-v4-1-0';
const SHELL = [
  './', './index.html', './boot.js', './login.css', './login.js', './painel.html', './demo-profissional.html', './styles.css', './care-network.css', './care-network.js', './config.js', './cloud.js', './app.js',
