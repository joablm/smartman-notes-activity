const CACHE_NAME = 'humanevo-premium-studio-v4-1-1';
const SHELL = [
  './', './index.html', './boot.js', './login.css', './login.js', './painel.html', './demo-profissional.html', './styles.css', './care-network-inline.css', './care-network-inline.js', './config.js', './cloud.js', './app.js',
